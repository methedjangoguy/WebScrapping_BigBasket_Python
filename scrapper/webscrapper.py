...
def parse_data(html, products_list, counter):
    ...
    for product in products:
        try:
            product_brand_name = product.find(
                "span",
        ...
        try:
            ...
            try:
                product_quantity = product.find(
                    "span",
                    class_="Label-sc-15v1nk5-0 CosmeticSelector___StyledLabel2-sc-81mggp-1 gJxZPQ hLFUWM",
                ).text.strip()
        ...
        try:
            product_original_price = product.find(
                "span",
                class_="Label-sc-15v1nk5-0 Pricing___StyledLabel2-sc-pldi2d-2 gJxZPQ hsCgvu",
            ).text.strip()
        ...
        try:
            product_sale_price = product.find(
                "span",
                class_="Label-sc-15v1nk5-0 gJxZPQ lg:text-sm xl:text-md font-semibold pr-5 py-0.5 ml-12",
            ).text.strip()
        ...
        products_list.append(
            {
                ...
                "Product Offered Price": product_offered_price,
                "Product Original Price": product_original_price,
